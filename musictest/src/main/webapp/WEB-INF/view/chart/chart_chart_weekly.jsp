...
<head>
    ...
    <title>chart_chart_weekly</title>
	    ...
	    <div id="container">
	        <div class="center">
	            <ul class="chart_btn clear">
	                <li><a href="/musictest/chart/chart_24hit.do">실시간</a></li>
	                <li><a href="/musictest/chart/chart_daily.do">일간</a></li>
	                <li class="active"><a href="/musictest/chart/chart_weekly.do">주간</a></li>
