...
<head>
    ...
    <title>chart_genre_classic</title>
    ...
    <script>
        ...
        window.onload = function () {
            ...
            function popup() {
                window.open("/chart/lyrics.do", "popup", "width=400, height=600");
            }
    ...
    <div id="container">
        <div class="center">
            <ul class="chart_btn clear">
                <li><a href="/musictest/chart/chart_genre_kpop.do">가요</a></li> 
                <li><a href="/musictest/chart/chart_genre_pop.do">POP</a></li>
                <li><a href="/musictest/chart/chart_genre_jazz.do">JAZZ</a></li>
                <li class="on"><a href="/musictest/chart/chart_genre_classic.do">CLASSIC</a></li>
            </ul>
