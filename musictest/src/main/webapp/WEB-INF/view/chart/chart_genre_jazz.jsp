    ...
    <div id="container">
        <div class="center">
            <ul class="chart_btn clear">
                ...
                <li class="on"><a href="/musictest/chart/chart_genre_jazz.do">JAZZ</a></li>
                <li><a href="/musictest/chart/chart_genre_classic.do">CLASSIC</a></li>
            </ul>
